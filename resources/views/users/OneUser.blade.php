...
<body>
	...
	<div id='header'>
		...
		<ul class='order_list'>
			<a href='/user/{{ $info['user_name'] }}'><li id="new_list" class="local_order">最新</li> <a/>
			<a href='/user/{{ $info['user_name'] }}/hot'><li id="hot_list">最热</li> <a/>
		</ul>
	...
	<script type="text/javascript" src="/js/load_next_userurl_page.js"></script>
	<script type="text/javascript">
