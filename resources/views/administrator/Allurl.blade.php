...
<head>
	...
	<title>管理员：所有分享 - iShare 网址压缩分享平台</title>
...
<body>
	...
	<div id='header'>
		...
		<ul class='menu_list'>
			...
			<a href='/administrator/allurl/1' id='local_page'>
				<li>
				<img src='/css/img/head_list_manger.png' alt='' class='head_list_img'/>管理员：所有分享</li>
			</a>
	...
	<div id='main_bk'>
		...
		<div id='main'>
			...
			<a href="/administrator/allurl/{{$info['page_last']}}"><button type="button" id="last_page_but" class="last_page_but_normal" value="{{$info['page_last']}}">上一页</button></a>
			<a href="/administrator/allurl/{{$info['page_next']}}"><button type="button" id="next_page_but" class="next_page_but_normal" value="{{$info['page_next']}}">下一页</button></a>
		</div>
	</div>
	<div id='footer'>
		<ul>
