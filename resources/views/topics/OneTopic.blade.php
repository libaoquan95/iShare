...
<head>
	...
	<title>话题广场/{{$info['topic_name']}} - iShare 网址压缩分享平台</title>
...
<body>
	...
	<div id='header'>
		...
		<ul class='order_list'>
			<a href='/topics/{{ $info['topic_name'] }}'><li id="new_list"  class="local_order">最新</li> <a/>
			<a href='/topics/{{ $info['topic_name'] }}/hot'><li id="hot_list">最热</li> <a/>
		</ul>
	...
	<script type="text/javascript" src="/js/load_next_topic_page.js"></script>
	<script type="text/javascript">
