$(document).ready(function(){
	...
	$("#next_page_but").click(function() {
		...
		var search_desc = $('#search_desc').text();
		var search_lurl = $('#search_lurl').text();
		var search_surl = $('#search_surl').text();
		var search_user = $('#search_user').text();

		$.post("/syshide/load_next_more_search_page",
		{
